...
static int g_mock_20_4ab3_calls = 0;
static void mock_20_4ab3(GBState *gb) {
    (void)gb;
...
static int g_mock_sync_flags_calls = 0;
static void mock_sync_flags(GBState *gb) {
    (void)gb;
    g_mock_sync_flags_calls++;
}

static int g_mock_reveal_object_calls = 0;
...
static int g_mock_spawn_chest_calls = 0;
static void mock_spawn_chest(GBState *gb) {
    (void)gb;
    g_mock_spawn_chest_calls++;
}

static int g_mock_spawn_stairs_calls = 0;
static void mock_spawn_stairs(GBState *gb) {
    (void)gb;
    g_mock_spawn_stairs_calls++;
}

static int g_mock_room_triggers_calls = 0;
static void mock_room_triggers(GBState *gb) {
    (void)gb;
    g_mock_room_triggers_calls++;
}

static uint16_t mock_get_adjacent_room_status_addr(GBState *gb, uint16_t room) {
    (void)gb;
